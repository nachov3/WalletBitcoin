...
**
**	Versi�n 1.7.0	(20/10/2014):	-Se cambiaron las consultas de mysql (depreciado) a mysqli.
**
**	Descripci�n :
 ...
 */
 ...
 if($_pagi_conteo_alternativo == false){
 	...
 	$_pagi_result2 = mysqli_query($con->getCnn(), $_pagi_sqlConta);
	...
	$_pagi_result3 = mysqli_query($con->get(), $_pagi_sql);
	// Si ocurri� error y mostrar errores est� activado
 	if($_pagi_result3 == false && $_pagi_mostrar_errores == true){
		die (" Error en la consulta de conteo alternativo de registros: $_pagi_sql. Mysql dijo: <b>".mysqli_error($conexion)."</b>");
 	}
 ...
 */
 ...
 $_pagi_result = mysqli_query($con->getCnn(), $_pagi_sqlLim);
 // Si ocurri� error y mostrar errores est� activado
