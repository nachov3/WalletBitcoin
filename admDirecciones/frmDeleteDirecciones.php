...
$fila=mysqli_fetch_array($_pagi_result);
...
<body style="background-color:#000000;">
    <div class="container">
      ...
      <div align="center"><font  size="4"><span class="txt anim-text-flow">Eliminar Claves</span></font></div><br>
      <div class="table table-responsive">
      <form action="deleteDirecciones.php" method="POST">
        <table  class="table-condensed " align="center" width="50%" eight="50%">
          ...
          <tr>
            ...
            <td><div align="center">
              <input type="text"  name="clave_publica" value="<?php echo $fila['clave_publica'] ?>" readonly>
            </div></td></tr>
          <tr>
            <td><div align="left"><font color="#FFFFFF">Clave Privada</font></div></td>
            <td><div align="center">
              <input type="text"  name="clave_privada" value="<?php echo $fila['clave_privada'] ?>" readonly>
            </div></td>
          </tr>
          <tr><td colspan="13"><input type="submit" name="enviar" value="Eliminar" class="btn btn-dark"></td></tr>
        </table>
        </div>
